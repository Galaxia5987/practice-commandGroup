...
import frc.robot.subsystems.helicopter.commands.SetPosition;
...
public class Bit extends SequentialCommandGroup {
    public Bit(Intake PickCargo, Conveyor Convey, Shooter Shoot, SwerveDrive SetDrivePower, SwerveDrive SetAnglePower, Helicopter SetPosition){
        addCommands(
                ...
                new SetPosition(new Rotation2d(0)).withTimeout(5)
        );
    }
}
